...
public class ProjectIsActiveUserTest {
	...
	@Test
	public void fn() {
		assertFalse(p1.isActiveUser(u1));
		assertFalse(p2.isActiveUser(u1));
		assertTrue(p3.isActiveUser(u1));
		assertTrue(p4.isActiveUser(u2));

		assertFalse(p1.isActiveUser(u2));
		assertFalse(p2.isActiveUser(u2));
		assertFalse(p3.isActiveUser(u2));
		assertFalse(p4.isActiveUser(u1));
	}
