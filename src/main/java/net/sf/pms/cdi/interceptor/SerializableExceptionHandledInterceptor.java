package net.sf.pms.cdi.interceptor;
 ...
 * <li>re-throw unhandled exception if not ObserverException class</li>
 * </ul>
 */
@Interceptor
@ExceptionHandled
public class SerializableExceptionHandledInterceptor implements Serializable {
	 ...
	 * 
	 * @param ctx
	 *            InvocationContext as defined by the Interceptor Spec.
	 * @return value of {@link javax.interceptor.InvocationContext#proceed()},
	 *         unless an exception occurs, if the method returns a primitive the
	 *         value will be 0 for int, short, long, float and false for
	 *         boolean.
	 */
	@AroundInvoke
