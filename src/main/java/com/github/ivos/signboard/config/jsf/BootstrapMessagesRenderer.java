...
public class BootstrapMessagesRenderer extends HtmlBasicRenderer {
	...
	public void encodeEnd(FacesContext context, UIComponent component)
		...
		while (messageIter.hasNext()) {
			...
			if (curMessage.getSeverity() == FacesMessage.SEVERITY_INFO) {
				severityStyle = (String) component.getAttributes().get(
						"infoStyle");
			...
			severityStyleClass = rendererSupport
					.getMessagesStyleClass(curMessage);
