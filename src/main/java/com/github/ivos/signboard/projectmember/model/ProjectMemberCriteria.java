...
public class ProjectMemberCriteria {
	...
	private ProjectMemberSort sort = ProjectMemberSort.alphabetically;
	...
	public ProjectMemberSort getSort() {
		return sort;
	}

	public void setSort(ProjectMemberSort sort) {
		this.sort = sort;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProjectMemberCriteria other = (ProjectMemberCriteria) obj;
		if (email == null) {
			if (other.email != null)
				return false;
	...
	public String toString() {
		return "ProjectMemberCriteria [email=" + email + ", firstName="
				+ firstName + ", lastName=" + lastName + ", phone=" + phone
				+ ", status=" + status + ", sort=" + sort
				+ ", registered__From=" + registered__From
				+ ", registered__To=" + registered__To + ", lastLogin__From="
				+ lastLogin__From + ", lastLogin__To=" + lastLogin__To + "]";
	}
